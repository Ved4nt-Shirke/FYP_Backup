// EditExtraTheoryAttendance1.jsx
...
const EditExtraTheoryAttendance1 = () => {
  ...
  const handleCiannClick = (ciannId) => {
    navigate("/edit-extra-theory-attendance2", { state: { selectedCiannId: ciannId } });
  };
      ...
      <div className="edit-ciann-page">
        <div className="edit-ciann-header">
          <h2 className="text-center py-2 bg-success text-white">
            Edit Extra Theory Attendance - Select CIAAN
          </h2>
        </div>
        <div className="ciann-card-container">
          {loading ? (
            ...
            ciannDataList.map((ciannData) => (
              ...
              >
                <i className="bi bi-plus-circle ciann-icon"></i>
