  ...
  return (
    ...
    >
      <div className="header-left">
        ...
        {/* Secondary menu toggle button for Ciaan sidebar */}
      ...
      <div className="header-right">
        ...
        {isFaculty && (
          <button
            className="Ciaan-request-bell"
            title={`Pending Ciaan requests: ${pendingCiaanRequests}`}
        ...
        <div className="user-section" ref={userDropdownRef}>
          ...
          {showUserDropdown && (
            <div
              className={`user-dropdown-menu ${showUserDropdown ? "visible" : ""
                }`}
            >
              {isSuperAdmin && (
                <button
