...
import PrintCiaan from "./faculty/editCiann/PrintCiann";
...
import TheoryCiaanCards from "./faculty/Attendance/TheoryAttend";
import SmartAttendanceHub from "./faculty/Attendance/SmartAttendanceHub";
import ExtraTheoryCiaanCards from "./faculty/Attendance/EtheoryCard";
import ExtraPracticalCiaanCards from "./faculty/Attendance/EpractCard";
import TutorialCiaanCards from "./faculty/Attendance/tutCard";
import PracticalCiaanCards from "./faculty/Attendance/PracticalCiannCards";
...
import AssismentCiaanCards from "./faculty/Assessment/assess/assismentCiann";
...
// MSBTE Formats Pages
import FAPRK3CiaanCards from "./pages/msbte/FAPRK3CiannCards";
import FAPRK3Generate from "./pages/msbte/FAPRK3Generate";
import FAPRK3Print from "./pages/msbte/FAPRK3Print";
import SAPRK4CiaanCards from "./pages/msbte/SAPRK4CiannCards";
...
import FATHK5CiaanCards from "./pages/msbte/FATHK5CiannCards";
import FATHK5Print from "./pages/msbte/FATHK5Print";
import AttendanceReport from "./pages/msbte/AttendanceReport";
import SATHCiaanCards from "./pages/msbte/SATHCiannCards";
...
import K7CiaanSelection from "./pages/msbte/K7CiannSelection";
...
import StudentWiseCiaanSelect from "./faculty/Assessment/studentDefaulter/StudentWiseCiannSelect";
...
const AppContent = () => {
  ...
  // Allow secondary pages (e.g., Ciaan flows) to toggle the main faculty sidebar
  useEffect(() => {
  ...
  if (isSpecialPage) {
    return (
      <Routes>
        ...
        <Route path="/edit-Ciaan-print" element={<PrintCiaan />} />
        <Route
      ...
      <div className="main-content-wrapper">
        <div className="scrollable-content">
          <Routes>
            ...
            <Route path="/create-Ciaan" element={<CreateCiaan />} />
            <Route path="/edit-Ciaan" element={<EditCiaan />} />
            ...
            <Route path="/theory-Ciaan-cards" element={<TheoryCiaanCards />} />
            <Route
              path="/extra-theory-Ciaan-cards"
              element={<ExtraTheoryCiaanCards />}
            />
            <Route
              path="/extra-practical-Ciaan-cards"
              element={<ExtraPracticalCiaanCards />}
            />
            <Route
              path="/tutorial-Ciaan-cards"
              element={<TutorialCiaanCards />}
            />
            <Route
              path="/practical-Ciaan-cards"
              element={<PracticalCiaanCards />}
            />
            <Route
            ...
            <Route
              path="/prac-form/:CiaanId/:weekNo/:batch/:exptNo"
            ...
            />
            <Route path="/assess-Ciaan" element={<AssismentCiaanCards />} />
            <Route
            ...
            <Route path="/studentwise-defaulters" element={<StudentWiseCiaanSelect />} />
            ...
            {/* CT & PT Routes */}
            <Route path="/ct-Ciaans" element={<CTCiaanCards />} />
            <Route path="/ct-dashboard/:CiaanId" element={<CTDashboard />} />
            <Route
            ...
            <Route
              path="/msbte/fa-pr-k3/Ciaans"
              element={<FAPRK3CiaanCards />}
            />
            <Route
              path="/msbte/sa-pr-k4/Ciaans"
              element={<SAPRK4CiaanCards />}
            />
            <Route
              path="/msbte/fa-th-k5/Ciaans"
              element={<FATHK5CiaanCards />}
            />
            <Route
            ...
            <Route
              path="/msbte/sa-th/Ciaans"
              element={<SATHCiaanCards />}
            />
            <Route
            ...
            {/* K7 Routes */}
            <Route
              path="/msbte/k7/Ciaans"
              element={<K7CiaanSelection />}
            />
            <Route
