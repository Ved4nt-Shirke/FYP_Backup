...
const K3Print = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const program = CiaanData.department?.name || "";
      const className = CiaanData.courseCode || CiaanData.class || CiaanData.division || "";
      const course = CiaanData.subject?.name || "";
      ...
      try {
        const studentsResult = await axios.get(config.students, {
          params: {
            batch,
            division: CiaanData.division || undefined,
            academicYear: CiaanData.academicYear || undefined,
            semester: CiaanData.semester || undefined,
          },
        });
      ...
      <div className="k3-page">
        <div className="k3-form-card">
          ...
          <p className="k3-error">
            Ciaan or batch information is missing. Please select again.
          </p>
          <button
    ...
    <div className="k3-print-container">
      ...
      <div className="k3-sheet">
        ...
        <div className="k3-meta">
          ...
          <div>
            <strong>Course and Code:</strong> {CiaanData.courseCode || CiaanData.class || ""}
          </div>
          <div>
            <strong>Subject and Code:</strong> {CiaanData.subject?.name || ""} (
