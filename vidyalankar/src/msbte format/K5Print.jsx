    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const ctMarksPromise = axios.get(
          `${config.apiBaseUrl}/ct-marks/${CiaanData.CiaanId}`,
        );
        ...
        setError("Failed to load students/CT marks for selected Ciaan.");
      } finally {
        setLoading(false);
      }
    };
        ...
        <table className="k5-table">
          ...
          <tbody>
            {loading ? (
              ...
              <tr>
                <td colSpan={8} className="k5-empty">No students found for this Ciaan division.</td>
              </tr>
            ) : (
              rows.map((row) => (
