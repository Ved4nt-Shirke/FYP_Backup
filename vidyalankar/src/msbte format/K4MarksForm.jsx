...
const K4MarksForm = () => {
    ...
    const loadData = async () => {
      ...
      try {
        ...
        const studentResponse = await axios.get(config.students, {
          params: { division, academicYear: CiaanData.academicYear, semester: CiaanData.semester },
        });
  ...
  const handleSave = async (event) => {
    ...
    if (!CiaanData || !division) {
      setError("Ciaan or division information is missing.");
      return;
    }
