      ...
      <div className="promotions-header">
        <div className="header-title-section">
          ...
          <p className="subtitle">
            Manage student progression and secure historical CIANN log records for <strong>{adminInstitution}</strong>.
          </p>
        </div>
      </div>
        ...
        <div className="glass-card archive-table-card">
          ...
          {archives.length === 0 ? (
            <div className="empty-archives-state">
              ...
              <p>No historical CIANN semesters found for this institution.</p>
            </div>
          ) : (
