      ...
      <div className="academic-year-management">
        ...
        <div className="page-header">
          <div>
            ...
            <p>Configure academic years, schemes, and track Ciaan progress across your institution</p>
          </div>
              ...
              <div>
                ...
                <div className="ay-stats-grid mb-xl">
                  ...
                  <div className="ay-stat-card">
                    ...
                    <div className="ay-stat-info">
                      <span className="ay-stat-value">{selectedYearStats.stats.completedCiaans}</span>
                  ...
                  <div className="ay-stat-card">
                    ...
                    <div className="ay-stat-info">
                      <span className="ay-stat-value">
                        {selectedYearStats.stats.activeCiaans + selectedYearStats.stats.archivedCiaans}
                      </span>
                ...
                {statsTab === "faculty" && (
                  <div className="table-wrapper">
                    {selectedYearStats.stats.facultyStats.length === 0 ? (
                      <p className="no-items-text">No Ciaans created under this academic year yet.</p>
                    ) : (
                      <table className="table">
                        <thead>
                          <tr>
                ...
                {statsTab === "department" && (
                  <div className="table-wrapper">
                    {selectedYearStats.stats.departmentStats.length === 0 ? (
                      <p className="no-items-text">No Ciaans mapped to any department yet.</p>
                    ) : (
                      <table className="table">
                        <thead>
                          <tr>
                ...
                {statsTab === "subject" && (
                  <div className="table-wrapper">
                    {selectedYearStats.stats.subjectStats.length === 0 ? (
                      <p className="no-items-text">No subjects linked to Ciaans yet.</p>
                    ) : (
                      <table className="table">
                        <thead>
                          <tr>
                ...
                {statsTab === "semester" && (
                  <div className="table-wrapper">
                    {selectedYearStats.stats.semesterStats.length === 0 ? (
                      <p className="no-items-text">No semester info mapped to Ciaans yet.</p>
                    ) : (
                      <table className="table">
                        <thead>
                          <tr>
          ...
          <div className="modal-overlay">
            <div className="modal" style={{ maxWidth: "450px" }}>
                ...
                {confirmDialog.type === "complete" ? (
                  <p>
                    ...
                    <span style={{ color: "var(--admin-danger)", fontWeight: "600" }}>
                      WARNING: This action makes all Ciaans associated with this year READ-ONLY. Faculty will not be able to edit their logbooks, attendance, or planning sheets.
                    </span>
                  </p>
                ) : confirmDialog.type === "delete" ? (
                  <p>
                    ...
                    <br />
                    <span style={{ color: "var(--admin-danger)", fontWeight: "600" }}>
                      ⚠️ WARNING: This action is irreversible. The academic year record will be permanently removed. Any Ciaans already linked to this year will remain intact but will no longer be associated with a year record.
                    </span>
                  </p>
                ) : (
                  <p>
              ...
              <div className="modal-footer">
                ...
                <button
                  type="button"
                  className={`btn ${confirmDialog.type === "complete" || confirmDialog.type === "delete"
                      ? "btn-danger"
                      : "btn-primary"
                    }`}
