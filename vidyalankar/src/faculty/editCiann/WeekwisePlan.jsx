...
const WeekwisePlan = ({
  ...
  useEffect(() => {
    const fetchExperiments = async () => {
      ...
      try {
        const payload = {
          program: CiaanData.department?.name || CiaanData.department,
          className: CiaanData.courseCode || CiaanData.class || "",
          course: CiaanData.subject?.name || CiaanData.subject,
        };
    ...
    <div style={modalStyles.overlay}>
      ...
      <div style={modalStyles.content}>
        ...
        <div className="weekwise-container flip-animate">
          ...
          {!loadingExperiments && experiments.length === 0 && CiaanData && (
            <div style={{
              padding: "10px",
              background: "#fff3cd",
              borderRadius: "5px",
