...
const ViewMarks = ({ activityType, CiaanId, courseId, refreshToken, onEdit }) => {
  ...
  }, [activityType, CiaanId, courseId, refreshToken]);
  ...
  const fetchMarks = async () => {
    ...
    try {
      ...
      if (CiaanId) params.append('CiaanId', CiaanId);
          ...
          <div className="table-responsive">
            <table className="table table-hover table-striped">
              ...
              <tbody>
                {marksData.map(item => (
                  <tr key={item._id}>
                    <td>{item.CiaanId ? `Ciaan-${item.CiaanId}` : '-'}</td>
