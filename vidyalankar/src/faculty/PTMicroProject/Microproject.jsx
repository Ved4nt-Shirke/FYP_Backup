...
const Microproject = () => {
  ...
  const buildWizardSearch = (overrides = {}) => {
    ...
    const nextCiannId = overrides.selectedCiannId ?? selectedCiannId;
    ...
    if (nextCiannId) params.set("ciannId", nextCiannId);
  ...
  useEffect(() => {
    ...
    const urlCiannId = searchParams.get("ciannId");
    ...
    if (urlCiannId) setSelectedCiannId(urlCiannId);
  ...
  const fetchCianns = async (departmentId, courseId) => {
    ...
    try {
      ...
      const filtered = (result || []).filter((ciann) => {
        ...
        const deptMatches =
          ciannDepartmentId?.toString() === departmentId?.toString();
        const courseMatches =
          ciannCourseId?.toString() === courseId?.toString() ||
          (selectedCourseCode &&
            ciannCourseCode?.toString() === selectedCourseCode?.toString());
  ...
  const selectedSubjectName =
    selectedCiann?.subject?.name ||
    selectedCiann?.subject?.subjectName ||
    "Unknown Subject";
  const selectedSubjectId =
    selectedCiann?.subject?._id || selectedCiann?.subjectId || "";
                ...
                <div className="row g-3">
                  ...
                  <div className="col-md-12">
                    ...
                    <select
                      ...
                      disabled={
                        !selectedDepartment || !selectedClass || loadingCianns
                      }
                    >
                        ...
                        handleSaveMarks(
                          {
                            ...
                            divisionId:
                              selectedCiann?.divisionId || marksData.divisionId,
                          },
