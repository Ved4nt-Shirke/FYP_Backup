...
export default function PTConfiguration() {
  ...
  const { Ciaan, subject, config: existingConfig } = location.state || {};
  ...
  useEffect(() => {
    ...
    fetchCourseDetails();
  }, [Ciaan, subject, existingConfig, navigate]);
  ...
  const handleSaveConfig = async () => {
    ...
    try {
      ...
      const bodyPayload = {
        ...
        courseId: Ciaan.courseId?._id || Ciaan.courseId,
        semester: Ciaan.semester,
        divisionId: Ciaan.divisionId || "60c72b2f9b1d8b2d88a299fa", // fallback default division object id if none
        subjectId,
      ...
      <div className="container-fluid py-4 px-md-5">
        ...
        <div className="d-flex align-items-center justify-content-between mb-4">
          ...
          <span className="badge bg-light text-secondary border px-3 py-2 rounded-pill">
            Ciaan {Ciaan.CiaanId} &bull; Sem {Ciaan.semester} &bull; Div {Ciaan.division}
          </span>
        </div>
