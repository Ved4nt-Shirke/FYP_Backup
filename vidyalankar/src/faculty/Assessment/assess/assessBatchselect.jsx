    ...
    try {
      ...
      navigate("/assess-pa", {
        state: {
          ...
          program: CiaanData.department?.name || "Computer Engineering", // Use actual department name
          className: CiaanData.courseCode || CiaanData.class || CiaanData.division || "CO1A", // Use actual class
          course: CiaanData.subject?.name || "BASIC MATHEMATICS" // Use actual subject name
        },
      });
    } catch (error) {
