        ...
        {CiaanData && (
          <div className="tutorial-modal-context-header">
            ...
            <p className="tutorial-modal-meta">
              Division: {CiaanData.division} | Department:{" "}
              {CiaanData.department?.name || "N/A"}
            </p>
          </div>
        )}
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const planRes = await fetch(
          `${(import.meta.env.VITE_API_BASE_URL || "http://localhost:5000").replace(/\/api$/, "")}/api/tutorial-plan/${CiaanId}`
        );
        ...
        const attRes = await fetch(
          `${(import.meta.env.VITE_API_BASE_URL || "http://localhost:5000").replace(/\/api$/, "")}/api/tutorial-attendance?CiaanId=${CiaanId}`
        );
        ...
        <div className="tutorial-page-container">
          ...
          <section className="tutorial-table-section">
            <div className="tutorial-table-head">
              ...
              <div className="tutorial-badge">CIAAN ID {CiaanData.CiaanId}</div>
            </div>
