...
const StudentAttendance = () => {
  ...
  useEffect(() => {
    ...
    if (CiaanDataStr) {
      try {
        const CiaanData = JSON.parse(CiaanDataStr);
        if (CiaanData.divisionId?._id || CiaanData.divisionId) {
          params.divisionId = CiaanData.divisionId?._id || CiaanData.divisionId;
        ...
        console.error("Error parsing CiaanData:", err);
      }
    }
  ...
  let CiaanData = null;
  try {
    CiaanData = CiaanDataStr ? JSON.parse(CiaanDataStr) : null;
  } catch (err) {
    console.error("Error parsing CiaanData:", err);
  }
    ...
    <div className="eia-page">
      <div className="eia-hero">
        ...
        <p className="eia-hero-subtitle">
          {CiaanData?.subject?.name || "Tutorial Session"}
        </p>
      </div>
