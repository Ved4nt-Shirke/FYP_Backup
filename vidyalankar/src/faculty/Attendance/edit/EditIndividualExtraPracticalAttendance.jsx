  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        setTimeout(() => {
          navigate('/edit-extra-practical-attendance2', { state: { selectedCiaanId: selectedCiaanId } });
        }, 1500);
      } else {
      ...
      <div className="edit-attendance-card">
        ...
        <form onSubmit={handleSubmit} className="edit-attendance-form">
          ...
          <div className="action-buttons-container">
            <button
              type="button"
              onClick={() => navigate('/edit-extra-practical-attendance2', { state: { selectedCiaanId: selectedCiaanId } })}
