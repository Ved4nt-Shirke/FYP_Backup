...
const EditExistingPracticalAttendance = () => {
  ...
  return (
    <div className="edit-attendance-page-container">
      <div className="edit-attendance-card">
        <h1 className="edit-attendance-heading">Edit Practical Attendance</h1>

        {/* Attendance Information Display */}
        <div className="context-fields-container">
          <div>
            <span className="context-label">Week No:</span>
            <div className="context-value">{attendanceRecord.weekNo || 'Not specified'}</div>
          </div>
          <div>
            <span className="context-label">Batch:</span>
            <div className="context-value">{attendanceRecord.batch || 'Not specified'}</div>
          </div>
          <div>
            <span className="context-label">Experiment:</span>
            <div className="context-value">{attendanceRecord.exptName} (No. {attendanceRecord.exptNo})</div>
          </div>
          <div>
