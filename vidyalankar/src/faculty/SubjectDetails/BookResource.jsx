...
import { bookResourcesApi, getCurrentCiaanId, handleApiError } from './api/subjectDetailsApi';
...
export default function BookResource() {
  ...
  const loadBookResources = async () => {
    try {
      ...
      const resources = await bookResourcesApi.getAll(CiaanId);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const dataToSubmit = { ...formData, CiaanId };
