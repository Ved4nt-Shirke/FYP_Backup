    ...
    >
      <div className="msbte-dropdown-container">
        ...
        {openSections.k3 && (
          <button
            className="msbte-dropdown-option"
            onClick={() => handleItemClick("/msbte/fa-pr-k3/Ciaans")}
          >
        ...
        {openSections.k4 && (
          <>
            <button
              className="msbte-dropdown-option"
              onClick={() =>
                handleItemClick("/msbte/sa-pr-k4/Ciaans?mode=generate")
              }
            >
              <i className="bi bi-dot"></i>
              <span>Generate</span>
            ...
            <button
              className="msbte-dropdown-option"
              onClick={() => handleItemClick("/msbte/sa-pr-k4/Ciaans?mode=edit")}
            >
              <i className="bi bi-dot"></i>
              <span>Edit</span>
            </button>
            <button
              className="msbte-dropdown-option"
              onClick={() =>
                handleItemClick("/msbte/sa-pr-k4/Ciaans?mode=print")
              }
            >
              <i className="bi bi-dot"></i>
              <span>Print</span>
        ...
        {openSections.saTh && (
          <>
            <button
              className="msbte-dropdown-option"
              onClick={() =>
                handleItemClick("/msbte/sa-th/Ciaans?mode=generate")
              }
            >
              <i className="bi bi-dot"></i>
              <span>Generate</span>
            ...
            <button
              className="msbte-dropdown-option"
              onClick={() => handleItemClick("/msbte/sa-th/Ciaans?mode=edit")}
            >
              <i className="bi bi-dot"></i>
              <span>Edit</span>
            </button>
            <button
              className="msbte-dropdown-option"
              onClick={() =>
                handleItemClick("/msbte/sa-th/Ciaans?mode=print")
              }
            >
              <i className="bi bi-dot"></i>
              <span>Print</span>
        ...
        <button
          className="msbte-dropdown-option"
          onClick={() => handleItemClick("/msbte/fa-th-k5/Ciaans")}
        >
          <i className="bi bi-file-earmark"></i>
          <span>FA-TH-K5</span>
        </button>
