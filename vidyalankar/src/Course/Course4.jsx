  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(
        "http://localhost:5000/api/get-experiments/update-experiment",
        payload
      );
    ...
    <div style={styles.container}>
      ...
      <form style={styles.form} onSubmit={handleSubmit}>
        ...
        <div style={styles.infoBox}>
          <p style={styles.infoItem}><strong>Program:</strong> {formData.program}</p>
          <p style={styles.infoItem}><strong>Class:</strong> {formData.className}</p>
          <p style={styles.infoItem}><strong>Course:</strong> {formData.course}</p>
        </div>

        <div style={styles.formGroup}>
          <label style={styles.label} htmlFor="practicalNo">Practical Number</label>
          <input
            style={styles.input}
            type="text"
            id="practicalNo"
        ...
        <div style={styles.formGroup}>
          <label style={styles.label} htmlFor="practicalName">Practical Name</label>
          <textarea
        ...
        <button style={styles.button} type="submit">Update Practical</button>
      </form>
    </div>
  );
};
