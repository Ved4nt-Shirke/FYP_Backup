...
export const config = {
  ...
  CiaanSubjectDetails: {
    get: (CiaanId) => `${API_BASE_URL}/subject-details/Ciaan-subject-details/${CiaanId}`,
    save: `${API_BASE_URL}/subject-details/Ciaan-subject-details`,
    uploadImage: `${API_BASE_URL}/subject-details/Ciaan-subject-details/knowledge-map-image`,
  },
