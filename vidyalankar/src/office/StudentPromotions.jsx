...
const StudentPromotions = () => {
  ...
  const handlePromoteSubmit = async (e) => {
    ...
    const confirmMsg = `Are you sure you want to promote ${selectedStudentIds.length} students to Academic Year ${targetAcademicYear.trim()}? Previous semester CIANNs for this source class will be frozen automatically.`;
      ...
      <div className="promotions-header">
        <div className="header-title-section">
          ...
          <p className="subtitle">
            Promote students and manage historical CIANN records for the <strong>{department?.name || "Loading..."}</strong> department in <strong>{institutionName}</strong>.
          </p>
        </div>
      </div>
        ...
        <div className="glass-card archive-panel">
          <div className="archive-header-row">
            <div>
              ...
              <p>Lock/freeze historical CIANN records to prevent further edits after promotion.</p>
            </div>
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        <span className="badge-count">
                          {item.completedCianns} / {item.totalCianns} completed
                        </span>
                      </td>
                      <td>
