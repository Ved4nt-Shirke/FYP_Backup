...
walk(srcDir, (filepath) => {
  ...
  if (relPath.startsWith('faculty/')) {
    ...
    if (depth === 2) {
      // e.g. src/faculty/editCiaan/Timetable.jsx
    ...
    const movedFolders = 'components|editCiaan|SubjectDetails|Attendance|Assessment|CT|Course|PTMicroProject|PracticalExam|chat';
