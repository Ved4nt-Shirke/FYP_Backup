...
import { moocCoursesApi, getCurrentCiannId, handleApiError } from './api/subjectDetailsApi';
...
export default function MoocCourses() {
  ...
  const loadMoocCourses = async () => {
    try {
      ...
      const courses = await moocCoursesApi.getAll(ciannId);
  ...
  const handleSubmit = async () => {
    try {
      ...
      await moocCoursesApi.saveAll(ciannId, validCourses);
