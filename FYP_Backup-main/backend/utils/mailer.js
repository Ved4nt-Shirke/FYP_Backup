...
const send2FACode = async (email, code) => {
  ...
  const mailOptions = {
    from: process.env.SMTP_FROM || `"CIANN Security" <no-reply@vpciaan.in>`,
    to: email,
    subject: "CIANN Superadmin 2FA Verification Code",
    html: `
      <div style="font-family: Arial, sans-serif; padding: 20px; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #eee; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
        <div style="background: linear-gradient(135deg, #28a745 0%, #20c997 100%); padding: 20px; text-align: center; border-radius: 8px 8px 0 0;">
          <h1 style="color: white; margin: 0; font-size: 24px;">CIANN</h1>
        ...
        <div style="padding: 20px;">
          ...
          <p>A login attempt was made to your CIANN Superadmin account. Please use the following 2FA verification code to complete your login:</p>
