...
const ctMarksSchema = new mongoose.Schema({
  ...
  // Context (to allow correct loading per Ciaan/Course)
  program: { type: String, required: false },
  className: { type: String, required: false },
  course: { type: String, required: false },
  CiaanId: { type: Number, required: true }, // Required for CT marks
...
// Create unique index for CT per student per Ciaan
ctMarksSchema.index({
  ctNumber: 1,
  studentName: 1,
  CiaanId: 1
